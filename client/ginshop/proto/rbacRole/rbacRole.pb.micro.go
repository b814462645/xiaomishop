...
type RbacRoleService interface {
	...
	RoleMiddlewaresAuth(ctx context.Context, in *RoleMiddlewaresAuthRequest, opts ...client.CallOption) (*RoleMiddlewaresAuthResponse, error)
}
...
func (c *rbacRoleService) RoleMiddlewaresAuth(ctx context.Context, in *RoleMiddlewaresAuthRequest, opts ...client.CallOption) (*RoleMiddlewaresAuthResponse, error) {
	req := c.c.NewRequest(c.name, "RbacRole.RoleMiddlewaresAuth", in)
	out := new(RoleMiddlewaresAuthResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type RbacRoleHandler interface {
	...
	RoleMiddlewaresAuth(context.Context, *RoleMiddlewaresAuthRequest, *RoleMiddlewaresAuthResponse) error
}
...
func RegisterRbacRoleHandler(s server.Server, hdlr RbacRoleHandler, opts ...server.HandlerOption) error {
	type rbacRole interface {
		...
		RoleMiddlewaresAuth(ctx context.Context, in *RoleMiddlewaresAuthRequest, out *RoleMiddlewaresAuthResponse) error
	}
...
func (h *rbacRoleHandler) RoleMiddlewaresAuth(ctx context.Context, in *RoleMiddlewaresAuthRequest, out *RoleMiddlewaresAuthResponse) error {
	return h.RbacRoleHandler.RoleMiddlewaresAuth(ctx, in, out)
}
