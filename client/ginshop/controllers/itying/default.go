...
func (con DefaultController) Index(c *gin.Context) {
	...
	if hasFocusList, err := models.CacheDb.Get("focusList", &focusList); !hasFocusList && err == nil {
	...
	if hasPhoneList, err := models.CacheDb.Get("phoneList", &phoneList); !hasPhoneList && err == nil {
	...
	if hasOtherList, err := models.CacheDb.Get("otherList", &otherList); !hasOtherList && err == nil {
